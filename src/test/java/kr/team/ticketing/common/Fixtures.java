    ...
    public static ReservationRequest.ReservationRequestBuilder aReservationRequest() {
        return ReservationRequest.builder()
                ...
                .optionRequests(asList(
                        ReservationOptionRequest.builder().description("뮤즈 공연입니다.").productId(1l).name("ADULT").price(23000).build(),
                        ReservationOptionRequest.builder().description("뮤즈 공연입니다.").productId(1l).name("TEENAGER").price(19000).build(),
                        ReservationOptionRequest.builder().description("뮤즈 공연입니다.").productId(1l).name("CHILDREN").price(17000).build()
                ));
    }
